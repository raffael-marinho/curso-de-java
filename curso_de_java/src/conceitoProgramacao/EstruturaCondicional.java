...
public class EstruturaCondicional {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("digite o primeiro numero inteiro:"); int numero =
		 * sc.nextInt(); if (numero<0) System.out.println("NEGATIVO"); else
		...
		/*
		 * System.out.println("digite o primeiro numero inteiro:"); int numero =
		 * sc.nextInt(); if (numero%2==0) System.out.println("PAR"); else
		...
		/*
		 * System.out.println("digite o primeiro numero inteiro:"); int numero1 =
		 * sc.nextInt(); System.out.println("digite o segundo numero inteiro:"); int
		 * numero2 = sc.nextInt();
		 * 
		...
		/*
		 * System.out.println("digite a hora inicial do jogo:"); int horaInicial =
		 * sc.nextInt(); System.out.println("digite a hora final do jogo:"); int
		 * horaFinal = sc.nextInt(); int calculoHora; if (horaInicial < horaFinal)
		 * calculoHora = horaFinal - horaInicial; else calculoHora = 24 - horaInicial +
		 * horaFinal;
		 * 
		...
		/*
		 * System.out.println("digite o codigo do item:"); int codigo = sc.nextInt();
		 * System.out.println("digite a quantidade:"); int quantidade = sc.nextInt();
		 * 
		 * if (codigo == 1) { System.out.println("Total: R$ " + quantidade*4.00); } else
		 * if(codigo == 2) { System.out.println("Total: R$ " + quantidade*4.50); }else
		 * if(codigo == 3) { System.out.println("Total: R$ " + quantidade*5.00); }else
		 * if(codigo == 4) { System.out.println("Total: R$ " + quantidade*2.00); }else
		 * if(codigo == 5) { System.out.println("Total: R$ " + quantidade*1.50); }
		 */
		 ...
		 * 
		 * if (entrada>=0.0) { if (entrada<=25.0) {
		 * System.out.println("Intervalo [0,25]\n"); }else if (25.0<entrada &&
		 * entrada<=50.0) { System.out.println("Intervalo [25,50]\n"); }else if
		 * (50.0<entrada && entrada<75.0) { System.out.println("Intervalo [50,75]\n");
		...
		/*
		 * System.out.println("digite o valor de x:"); double x = sc.nextDouble();
		 * System.out.println("digite o valor de y:"); double y = sc.nextDouble();
		 * 
		...
		/*
		 * System.out.println("digite seu salario para calcular o imposto:"); double
		 * salario = sc.nextDouble();
		 * 
		 * double calculoImposto = 0.0;
		 * 
		 * if (salario<=2000.00) { calculoImposto = 0.0; }else if (salario>= 2000.01 &&
		 * salario<=3000.00) { calculoImposto =(salario - 2000.0) * 0.08; }else if
		 * (salario>= 3000.01 && salario<=4500.00) { calculoImposto = (salario - 3000.0)
		 * * 0.18 + 1000.0 * 0.08; }else if (salario> 4500.00) { calculoImposto =
